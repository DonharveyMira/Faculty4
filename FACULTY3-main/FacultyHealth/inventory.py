...
prodCodeLab = Label(medicinePan, text="Product Code", font=("Microsoft JhengHei", 11, "bold"), 
                    bg="#FBF0D7", fg="#497687")
prodCodeLab.place(relx=0.04, rely=0.1, anchor=W)
prodCodeEnt = Entry(medicinePan,textvariable=product_code, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
prodCodeEnt.place(relx=0.663, rely=0.1, anchor=CENTER)

medNameLab = Label(medicinePan, text="Medicine Name", font=("Microsoft JhengHei", 11, "bold"), 
                      bg="#FBF0D7", fg="#497687")
medNameLab.place(relx=0.04, rely=0.16, anchor=W)
medNameEnt = Entry(medicinePan,textvariable=meds_name, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
medNameEnt.place(relx=0.663, rely=0.16, anchor=CENTER)

descLab = Label(medicinePan, text="Description", font=("Microsoft JhengHei", 11, "bold"), 
                      bg="#FBF0D7", fg="#497687")
descLab.place(relx=0.04, rely=0.22, anchor=W)
descEnt = Entry(medicinePan,textvariable=description, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
descEnt.place(relx=0.663, rely=0.22, anchor=CENTER)

quantLab = Label(medicinePan, text="Quantity", font=("Microsoft JhengHei", 11, "bold"), 
                      bg="#FBF0D7", fg="#497687")
quantLab.place(relx=0.04, rely=0.28, anchor=W)
quantEnt = Entry(medicinePan,textvariable=quantity, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
quantEnt.place(relx=0.663, rely=0.28, anchor=CENTER)
...
eqpIdLab = Label(equipPan, text="Equiment ID", font=("Microsoft JhengHei", 11, "bold"), 
                    bg="#FBF0D7", fg="#497687")
eqpIdLab.place(relx=0.04, rely=0.1, anchor=W)
eqpIdEnt = Entry(equipPan, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
eqpIdEnt.place(relx=0.663, rely=0.1, anchor=CENTER)
